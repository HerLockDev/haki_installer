...
async def oturumacvebotlogolustur (stri, aid, ahash):
    try:
        ...
        Photo = await Client.upload_file(file='haki.jpg')
...
if __name__ == "__main__":
    ...
    config['DEFAULT_BIO'] = "✨ @HakiUserBot"
    ...
    config['TZ'] = TZ
    config['TZ_NUMBER'] = "1"
    config['UPSTREAM_REPO_URL'] = "https://github.com/HerLockDev/haki"
    config['SEVGILI'] = "None"
    config['WARN_LIMIT'] = "3"
